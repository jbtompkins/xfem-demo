...
# XFEM Demo Test
# Name: node_interface
# Purpose: We put the interface at the same location as an existing node to test
#   that the cutting and XFEM methods can properly evaluate a material
#   discontinuity at the same location as a node on the original mesh (not add
